                                    ...
                                    <div class="form-group">
                                        <select class="form-control select2" style="width: 100%;" id="id_select_zona" name="IdZona">
                                            ...
                                            @foreach($Usuarios as $u)
                                                <option value="{{ $u->id }}">{{ strtoupper( $u->nombre ) }} | {{ strtoupper( $u->rol_name ) }}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="form-group">
                                        <div class="input-group date" id="dt-end" data-target-input="nearest">
                                            ...
                                            <div class="card-tools">
                                                ...
                                                <button type="button" class="btn btn-success" id="btn-exportar-bitacora" onclick="ExportarBitacora()">
