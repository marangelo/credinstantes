...
<section class="content">
    ...
    <div class="row">
        ...
        <div class="card">
            ...
            <div class="row">                  
                <div class="col-md-3">
                <label id="lbl_deposito_dia" >EFECTIVO ENTREGADO.</label>
                ...
                <div class="col-md-3">
                    <label id="lbl_deposito_tranferencia" >EFECTIVO DESEMBOLSADO.</label>
                    <div class="input-group">
                        <div class="input-group-prepend">
                            <span class="input-group-text bg-light">C$.</span>
                        </div>
                ...
                <div class="col-md-3">
                    <label>EFECTIVO SOBRANTE </label><em>(ENTREGADO - DESEMBOLSADO)</em>               
                    <div class="input-group">
                        <div class="input-group-prepend">
                            <span class="input-group-text bg-light"> C$. </span>
                        </div>
                ...
                <div class="col-md-3">
                    <label id="lbl_gastos">EFECTIVO CONCILIADOS.</label>
                    <div class="input-group">
                        <div class="input-group-prepend">
                            <span class="input-group-text bg-light">C$.</span>
                        </div>
