                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="col-md-1 text-center">{{ $Abono->credito->estado->nombre_estado}} </td>
                        </tr>
                        <tr>
                            <td class="col-md-9"><em>FECHA DE VENCIMIENTO</em></h4></td>
                            <td class="col-md-1 text-center">{{ $Abono->credito->fecha_ultimo_abono}}</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td class="col-md-1 text-center">C$ {{ $Abono->saldo_actual}}</td>
                        </tr>
                        <tr>
